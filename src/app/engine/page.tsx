 ...
 *
 * Obsidian-and-gold precision instrument: private-bank gravitas fused with
 * engine-room awe. The three.js hero shows unstructured paper passing through
 * a golden scanning gate and emerging as an ordered lattice of data — the
 * product's promise rendered literally. Everything below the hero is DOM-only
 * and scroll-choreographed.
 */
...
function Header() {
  return (
    <header className="eng-header">
      <Link href="/engine/" className="eng-wordmark" aria-label="FinTrace — The Evidence Engine">
        <span>Fin</span>
