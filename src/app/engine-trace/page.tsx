 ...
 *
 * The engine's obsidian-and-gold system fused with the investigative
 * diagrams: the hero emits gold-edged evidence cards joined by filaments,
 * and a dedicated tracing section carries the account-network diagram and
 * the reconstructed cross-currency match — both re-skinned entirely into
 * engine palette and type. Crimson appears ONLY on flagged elements.
 */
...
function Header() {
  return (
    <header className="eng-header">
      <Link href="/engine-trace/" className="eng-wordmark" aria-label="FinTrace — The Evidence Engine, trace variant">
        <span>Fin</span>
    ...
    <div className={clsx('dsn-engine-trace', bricolage.variable, fragmentMono.variable)}>
      ...
      <main>
        ...
        <section className="eng-section eng-cv" id="tracing">
          <div className="eng-container">
            <Reveal className="eng-section-head">
              <p className="eng-kicker">Trace analysis</p>
              <h2 className="eng-h2">
            ...
            <Reveal className="eng-plate eng-ecm-plate" delay={160}>
              <CurrencyMatch />
            </Reveal>
          </div>
        </section>
