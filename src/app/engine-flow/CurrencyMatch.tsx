 ...
 * MATCHED plate stamps in above the landed chip. The plate row (y 40-64) and
 * the chip's landing row (y 78-102) are deliberately separate bands, and the
 * outer stations sit well inside the viewBox — no overlap, no clipped labels.
