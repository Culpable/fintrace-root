...
function Header() {
  return (
    <header className="eng-header">
      <Link href="/engine-refined/" className="eng-wordmark" aria-label="FinTrace — The Evidence Engine, refined variant">
        <span>Fin</span>
...
export default function EnginePage() {
  return (
    <div className={clsx('dsn-engine-refined', bricolage.variable, fragmentMono.variable, fragmentMonoApprox.variable)}>
      <Header />
      <main>
        <Hero />
