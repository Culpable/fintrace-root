...
- Assert the built HTML ships no render-blocking stylesheet and no more than one font preload. Both regress silently: the page still renders, so no functional test and no screenshot catches them.
